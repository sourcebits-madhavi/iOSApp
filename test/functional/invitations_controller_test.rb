...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { is_accept: @invitation.is_accept, iv_fb_id: @invitation.iv_fb_id }
    end
  ...
  test "should update invitation" do
    put :update, id: @invitation, invitation: { is_accept: @invitation.is_accept, iv_fb_id: @invitation.iv_fb_id }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
